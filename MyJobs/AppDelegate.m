...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    UITabBarItem *searchItem = [[UITabBarItem alloc] initWithTitle: @"Search" image: search selectedImage: search];
    searchView.tabBarItem = searchItem;
    [tab addChildViewController: searchNav];
    
    UIImage *favorites = [UIImage imageNamed: @"favorites.png"];
    UITabBarItem *favoritesItem = [[UITabBarItem alloc] initWithTitle: @"Favorites" image: favorites selectedImage: favorites];
    favoritesView.tabBarItem = favoritesItem;
    [tab addChildViewController: favoritesNav];
    
    UIImage *settings = [UIImage imageNamed: @"settings.png"];
    UITabBarItem *settingsItem = [[UITabBarItem alloc] initWithTitle: @"Settings" image: settings selectedImage: settings];
...
- (NSURL *)applicationDocumentsDirectory {
    // The directory the application uses to store the Core Data store file. This code uses a directory named "cwolf.MyJobs" in the application's documents directory.
...
- (NSManagedObjectModel *)managedObjectModel {
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"MyJobs" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator {
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"MyJobs.sqlite"];
    NSError *error = nil;
